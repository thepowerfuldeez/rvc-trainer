...
vctk_speakers = {x.name for x in Path("/mnt/harddrive/datasets/speech/vctk/wav48_silence_trimmed").iterdir() if x.is_dir()}
...
opensinger_n2id = json.loads(Path("/home/george/ai-covers-backend/src/rvc/logs/pretrain_1228/opensinger_name2id.json").read_text())
...
acappella_n2id = json.loads(Path("/home/george/ai-covers-backend/src/rvc/logs/pretrain_1228/acappella_name2id.json").read_text())
...
dsd100_n2id = json.loads(Path("/home/george/ai-covers-backend/src/rvc/logs/pretrain_1228/dsd100_name2id.json").read_text())
...
mixing_secrets_n2id = json.loads(Path("/home/george/ai-covers-backend/src/rvc/logs/pretrain_1228/mixing_secrets_name2id.json").read_text())
